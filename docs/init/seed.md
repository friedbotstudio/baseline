...
│   ├── hooks/                  # 24 hook scripts: 19 write/run-boundary guards + 4 lifecycle hooks + 1 input-boundary hook (Node ESM, no jq)
...
### §4.1 Hooks (24 total — 19 write/run-boundary guards + 4 lifecycle hooks + 1 input-boundary hook)
