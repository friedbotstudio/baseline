...
- **read-before-write (VI.7)** ✅ **shipped** (`c58b30d`) — was §8 of the context7 brief, dropped from `2c3007e`, re-captured as `docs/handoff/read-before-overwrite-convention.md`, then landed.
