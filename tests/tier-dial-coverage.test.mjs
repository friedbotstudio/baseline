...
const EXPECTED = ['brainstorm', 'spec', 'tdd', 'security', 'review', 'ac-conformance', 'spec-rollout', 'code-structure', 'design-judge'];
...
const REPRESENTATIVES = {
  ...
  'code-structure': '.claude/skills/code-structure/oracle.mjs',
  'design-judge': '.claude/skills/harness/design-judge.mjs',
};
