// Smoke test for the generated sitemap: build the site, then assert sitemap.xml
...
// Build is slow (~eleventy) and goes to this process's own output dir via
// helpers/site-build.mjs — never the live obj/site, which audit-baseline reads
// concurrently. Skip it (against a tree you just built) with SITE_SKIP_BUILD=1.
