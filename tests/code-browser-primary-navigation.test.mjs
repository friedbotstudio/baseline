...
const CLAUDE_TARGET_MAX = 39000; // >= 1000 headroom (AC-007; lowered by claude-md-pointer-rewrite, raised +500 by harden-epic-approved-flip for the epic_approval_guard row, +500 by phase-timing-instrumentation for the phase_timer row, +500 by checker-graduation-fanout for the §II.A oracle-checker fan-out clause, +500 by erp-portables slice A for the §4.2-A advisory-subagents clause, +1000 by erp-portables slice C for the Art. IV gate-C-conditional row and the Art. VII autonomous-landing rule, +1500 by erp-portables slice DEF for the Art. IV Step-0 triage rule, the XI.3 derivation-first rewrite, and the XI.12 decision-economy clause, +500 by erp-portables slice GHI for the VI.4 two-sided-faithful-scope clause. forbidden-git-ops-spellings added the Art. VII worktree-path-discard rule and did NOT raise this: it paid for itself by relocating Article XII's duplicated manifest mechanics to the annex per Art. I.6, leaving CLAUDE.md ~1k smaller than before the amendment)
