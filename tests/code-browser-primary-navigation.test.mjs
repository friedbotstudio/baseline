...
const CLAUDE_TARGET_MAX = 36000; // >= 4000 headroom (AC-007; lowered by claude-md-pointer-rewrite, raised +500 by harden-epic-approved-flip for the epic_approval_guard row, +500 by phase-timing-instrumentation for the phase_timer row, +500 by checker-graduation-fanout for the §II.A oracle-checker fan-out clause, +500 by erp-portables slice A for the §4.2-A advisory-subagents clause)
