...
governs: .claude/skills/memory-sync/SKILL.md
---
...
- Raised-in-context: (no active workflow) — ad-hoc `/memory-sync` during the stop-notifier correction
