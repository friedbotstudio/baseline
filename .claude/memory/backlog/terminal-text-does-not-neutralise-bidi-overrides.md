---
key: terminal-text-does-not-neutralise-bidi-overrides
category: backlog
scope: []
status: open
...
- Intent: LOW. `terminal-text.mjs` strips C0/C1 control characters and backticks but leaves the Unicode bidi overrides (U+202A-U+202E, U+2066-U+2069) intact, so a repository-controlled filename can render in a misleading order in a terminal. Confirmed absent at 3eafe4f.
