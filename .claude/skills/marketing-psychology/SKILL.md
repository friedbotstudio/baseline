...
Read `PRODUCT.md` if it exists. The product, audience, and brand voice should drive principle selection — not the other way around.
...
- [ ] Audience-specific phrasing pulled from `PRODUCT.md`
