...
A repository overlay. It installs **26 hooks** at Claude's tool boundaries, **56 skills**, **1 subagent**, **9 workflow tracks**, and **4 consent gates** you type yourself.
...
| **Skills** across fifteen categories: artifact drafting, workflow phases, phase workers, spec helpers, orchestration, memory, navigation, phase helpers, generators, audit, alternate tracks, shared globals, maintenance, sprint, and roadmap | 56 | `.claude/skills/` |
